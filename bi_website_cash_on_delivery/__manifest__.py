...

{
    ...
    'summary': 'App allow website COD store  shop cash on delivery payment Shop COD Store COD eCommerce COD Shop cash on delivery store cash on delivery order cash on delivery COD order shop Order COD order cash payment COD payment method webshop COD ',
